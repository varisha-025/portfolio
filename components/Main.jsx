      ...
      <div className='max-w-[1240px] w-full h-full mx-auto py-2 flex justify-center items-center'>
        <div className='pt-14 pb-12'>
          ...
          <div className='flex items-center text-center justify-center '>
            ...
            <Link href="https://drive.google.com/file/d/1_HxwR_WMChlgHeskXL7xI8CjM9AqJqnv/view?usp=sharing" ><button className='my-11 py-3 px-4 ml-7 hover:text-[#232946] md:ml-2 cursor-pointer text-lg shadow-gray-400 rounded-xl uppercase bg-[#EEBBC3] hover:scale-110 ease-in duration-300 text-white'>Resume</button></Link>
          </div>
        </div>
      </div>
    </div>
