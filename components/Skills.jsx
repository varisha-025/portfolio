...
import postgreIcon from '../public/assets/skills/postgresql.png'
import awsIcon from '../public/assets/skills/amazon-web-services.png'
    ...
    <div id='skills' className='w-full lg:h-screen p-2 pt-32'>
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8 py-6'>
          ...
          <SkillItem src={graphqlIcon} name="GraphQL" />
          <SkillItem src={awsIcon} name="AWS" />
          <SkillItem src={postgreIcon} name="PostgreSQL" />
