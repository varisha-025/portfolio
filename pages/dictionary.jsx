    ...
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
        <div className='col-span-4'>
          ...
          <Link href={"https://varisha-025.github.io/Dictionary_App/"}><button className='px-5 py-2 mt-4 mr-8'>Demo</button></Link>
          <Link href={"https://github.com/varisha-025/Dictionary_App"}><button className='px-5 py-2 mt-4'>Code</button></Link>
        </div>
